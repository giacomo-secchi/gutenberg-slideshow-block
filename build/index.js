...
_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default().createRootURLMiddleware(rootURL));
_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default().use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default().createNonceMiddleware(nonce));
...
class BlockEdit extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  componentDidMount() {
    ...
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5___default()({
      url: 'https://eternedile.it/wp-json/wp/v2/posts',
      mode: 'cors',
  ...
  render() {
    ...
    posts.forEach(data => {
      ...
      slides.push((0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        className: "swiper-slide"
      }, data.title.rendered));
    });
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, this.state.loading ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.Spinner, null) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "swiper"
    }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      className: "swiper-wrapper"
    }, slides), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
 ...
 */
function save() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps.save(), 'Gutenberg Slideshow Block – hello from the saved content!');
}
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"create-block/gutenberg-slideshow-block","version":"0.1.0","title":"Gutenberg Slideshow Block","category":"widgets","icon":"smiley","description":"Example block scaffolded with Create Block tool.","supports":{"html":false},"textdomain":"gutenberg-slideshow-block","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkgutenberg_slideshow_block"] = self["webpackChunkgutenberg_slideshow_block"] || [];
